...
const TaskListElement = ({settasks, ...props}) => {
    // const delTask = () => {
    ...
    return (
        <div className='container-task'>
            <div className="two" style={{background: props.task.bg}}>
                <div className="container text-center">
                <table className='table' style={{background: props.task.bg}}>
                    <tbody style={{background: props.task.bg}}>
                    <tr>
                        <th> {props.task.title}</th>
                        <th> {props.task.owner}</th>
                        <th>{props.task.createDate}</th>
                        <th>
